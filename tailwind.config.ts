	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'status-followup': 'hsl(var(--status-followup))',
				'status-won': 'hsl(var(--status-won))',
				'status-lost': 'hsl(var(--status-lost))',
				
				// Enhanced semantic colors - Professional automotive system
				success: {
				...
				// Automotive-specific professional colors
				automotive: {
